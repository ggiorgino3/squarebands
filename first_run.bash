...
sail artisan tinker --execute="DB::table('options')->insert(array('visible_on_frontend' => '0', 'title' => '', 'meta_key' => 'mm_description_url_photo', 'meta_value' => 'https://upload.wikimedia.org/wikipedia/commons/1/1b/Mike-Mangini-e1565969275373.jpg'));" && echo "50%"
sail artisan tinker --execute="DB::table('options')->insert(array('visible_on_frontend' => '0', 'title' => '', 'meta_key' => 'jm_description_url_photo', 'meta_value' => 'https://www.ondamusicale.it/wp-content/uploads/2017/01/john-myung.jpg'));" && echo "55%"
sail artisan tinker --execute="DB::table('options')->insert(array('visible_on_frontend' => '0', 'title' => '', 'meta_key' => 'jr_description_url_photo', 'meta_value' => 'https://www.therockpit.net/wp-content/uploads/2018/10/jordanrudess-promo2-1024x899.jpeg'));" && echo "60%"
sail artisan tinker --execute="DB::table('options')->insert(array('visible_on_frontend' => '0', 'title' => '', 'meta_key' => 'jl_description_url_photo', 'meta_value' => 'https://loudandproud.it/site/wp-content/uploads/2020/09/james-labrie-2020.jpg'));" && echo "66%"
sail artisan tinker --execute="DB::table('options')->insert(array('visible_on_frontend' => '0', 'title' => '', 'meta_key' => 'jp_description_url_photo', 'meta_value' => 'https://www.themoviedb.org/t/p/w500/aUxB7TUxF64nUBu9orbvORcX7Nz.jpg'));" && echo "75%"
sail artisan tinker --execute="DB::table('options')->insert(array('visible_on_frontend' => '0', 'title' => '', 'meta_key' => 'video_maximum_size', 'meta_value' => '10'));" && echo "80%"
sail artisan tinker --execute="DB::table('options')->insert(array('visible_on_frontend' => '0', 'title' => '', 'meta_key' => 'video_valid_extensions', 'meta_value' => 'avi,mp4'));" && echo "85%"
sail artisan tinker --execute="DB::table('options')->insert(array('visible_on_frontend' => '0', 'title' => '', 'meta_key' => 'photo_maximum_size', 'meta_value' => '3'));" && echo "88%"
sail artisan tinker --execute="DB::table('options')->insert(array('visible_on_frontend' => '0', 'title' => '', 'meta_key' => 'photo_valid_extensions', 'meta_value' => 'png,jpg,jpeg'));" && echo "92%"
sail artisan tinker --execute="DB::table('options')->insert(array('visible_on_frontend' => '0', 'title' => '', 'meta_key' => 'song_maximum_size', 'meta_value' => '10'));" && echo "94%"
sail artisan tinker --execute="DB::table('options')->insert(array('visible_on_frontend' => '0', 'title' => '', 'meta_key' => 'song_valid_extensions', 'meta_value' => 'mp3'));" && echo "97%"
sail artisan tinker --execute="DB::table('options')->insert(array('visible_on_frontend' => '0', 'title' => '', 'meta_key' => 'fb_link', 'meta_value' => 'https://facebook.com/dreamtheater'));"
sail artisan tinker --execute="DB::table('options')->insert(array('visible_on_frontend' => '0', 'title' => '', 'meta_key' => 'ig_link', 'meta_value' => 'https://instagram.com/dreamtheaterofficial'));" && echo "99%"
